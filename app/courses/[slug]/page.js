    ...
    <>
      ...
      <section style={{ background: '#1C2213', padding: '80px 40px 60px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <div className="course-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '60px', alignItems: 'start' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', marginBottom: '40px' }}>
                {[
                  ...
                  <div key={chip.label} style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '10px 16px' }}>
                    <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: '11px', marginBottom: '2px' }}>{chip.label}</div>
                    <div style={{ color: '#fff', fontWeight: '600', fontSize: '14px' }}>{chip.value}</div>
                  </div>
                ))}
              </div>

              <div style={{ display: 'flex', gap: '14px', flexWrap: 'wrap' }}>
                <a href="#enroll" style={{ background: '#5AB240', color: '#fff', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: '700', fontSize: '15px' }}>
                  Enroll Now →
                </a>
                <a href="https://wa.me/919963384555" target="_blank" style={{ background: 'rgba(255,255,255,0.06)', color: '#fff', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', fontSize: '15px', border: '1px solid rgba(255,255,255,0.15)' }}>
                  💬 Talk to Us
                </a>
              </div>
            </div>
            ...
            {/* Right — Sticky Card */}
            <div style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '28px', position: 'sticky', top: '100px' }}>
              <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px', marginBottom: '4px' }}>Course Fee</div>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' }}>
                  <span style={{ fontSize: '32px', fontWeight: '800', color: '#fff', fontFamily: 'var(--font-playfair)' }}>{course.finalFee}</span>
                  <div>
      ...
      <section style={{ background: '#f8faf7', padding: '80px 40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div className="course-content-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '60px', alignItems: 'start' }}>

            {/* Left Content */}
            <div>

              {/* What You Will Learn */}
              <div style={{ background: '#fff', borderRadius: '16px', padding: '36px', marginBottom: '24px', border: '1px solid #eef0ec' }}>
                <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: '26px', color: '#1C2213', fontWeight: '700', marginBottom: '24px' }}>
                  What You Will Learn
                </h2>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }} className="learn-grid">
                  ...
                  {course.modules.map((mod, i) => (
                    <div key={i} style={{ border: '1px solid #eef0ec', borderRadius: '10px', overflow: 'hidden' }}>
                      <button
                        ...
                        style={{ width: '100%', padding: '16px 20px', background: openModule === i ? course.bg : '#fafafa', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'space-between', textAlign: 'left' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                          <span style={{ background: course.color, color: '#fff', width: '26px', height: '26px', borderRadius: '50%', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: '700', flexShrink: 0 }}>
                            {i + 1}
                          </span>
                          <span style={{ fontWeight: '600', fontSize: '15px', color: '#1C2213' }}>{mod.name}</span>
                        </div>
                        <span style={{ color: course.color, fontSize: '20px', fontWeight: '300' }}>{openModule === i ? '−' : '+'}</span>
                      </button>
                      {openModule === i && (
                        <div style={{ padding: '16px 20px 20px 58px', background: '#fff' }}>
              ...
              <div style={{ background: '#fff', borderRadius: '16px', padding: '36px', marginBottom: '24px', border: '1px solid #eef0ec' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '32px' }} className="who-grid">
                  <div>
              ...
              {/* Career Outcomes */}
              <div style={{ background: '#1C2213', borderRadius: '16px', padding: '36px', marginBottom: '24px' }}>
                <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: '26px', color: '#fff', fontWeight: '700', marginBottom: '24px' }}>
                  Career Outcomes
                </h2>
                  ...
                  {course.faqs.map((faq, i) => (
                    <div key={i} style={{ border: '1px solid #eef0ec', borderRadius: '10px', overflow: 'hidden' }}>
                      <button
                        ...
                        style={{ width: '100%', padding: '16px 20px', background: openFaq === i ? '#f8faf7' : '#fff', border: 'none', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'center', textAlign: 'left' }}>
                        <span style={{ fontWeight: '600', fontSize: '15px', color: '#1C2213' }}>{faq.q}</span>
                        <span style={{ color: '#5AB240', fontSize: '20px', fontWeight: '300', flexShrink: 0, marginLeft: '12px' }}>{openFaq === i ? '−' : '+'}</span>
                      </button>
                      {openFaq === i && (
                        <div style={{ padding: '0 20px 16px', background: '#f8faf7' }}>
            ...
            <div style={{ position: 'sticky', top: '100px' }} id="enroll">
              ...
              {/* Enroll Form */}
              <div style={{ background: '#fff', borderRadius: '16px', padding: '28px', border: '1px solid #eef0ec', marginBottom: '16px', boxShadow: '0 4px 24px rgba(0,0,0,0.06)' }}>
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    <input
                      ...
                      style={{ padding: '12px 14px', borderRadius: '8px', border: '1px solid #e0e0e0', fontSize: '14px', outline: 'none', fontFamily: 'var(--font-inter)' }}
                    />
                    <input
                      type="tel"
                    ...
                    <textarea
                      ...
                      style={{ padding: '12px 14px', borderRadius: '8px', border: '1px solid #e0e0e0', fontSize: '14px', outline: 'none', resize: 'none', fontFamily: 'var(--font-inter)' }}
                    />
                    <button type="submit" style={{ background: '#5AB240', color: '#fff', padding: '14px', borderRadius: '8px', border: 'none', fontWeight: '700', fontSize: '15px', cursor: 'pointer' }}>
                      Submit Enquiry →
                    </button>
                  </form>
                )}
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/919963384555" target="_blank" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', background: '#25D366', color: '#fff', padding: '14px', borderRadius: '10px', textDecoration: 'none', fontWeight: '700', fontSize: '15px', marginBottom: '16px' }}>
              ...
              {/* Call */}
              <a href="tel:+919963384555" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', background: '#1C2213', color: '#fff', padding: '14px', borderRadius: '10px', textDecoration: 'none', fontWeight: '600', fontSize: '15px' }}>
                📞 Call +91 9963384555
              </a>
          ...
          <div style={{ marginTop: '80px' }}>
            <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: '32px', color: '#1C2213', fontWeight: '700', marginBottom: '32px' }}>
              Related Courses
            </h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }} className="related-grid">
              {relatedCourses.map(c => (
                <Link key={c.slug} href={`/courses/${c.slug}`} style={{ background: '#fff', borderRadius: '14px', padding: '24px', border: '1px solid #eef0ec', textDecoration: 'none', display: 'block', transition: 'all 0.3s' }}
                  onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 12px 40px rgba(0,0,0,0.1)' }}
                  onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none' }}>
                  <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: c.bg, borderRadius: '10px', width: '44px', height: '44px', color: c.color, fontWeight: '800', fontSize: '12px', marginBottom: '14px' }}>
                    {c.icon}
                  </div>
                  <div style={{ fontWeight: '700', color: '#1C2213', fontSize: '16px', marginBottom: '6px' }}>{c.title}</div>
                  <div style={{ color: '#888', fontSize: '13px', marginBottom: '12px' }}>⏱ {c.duration}</div>
