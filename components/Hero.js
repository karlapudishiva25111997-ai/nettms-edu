  ...
  return (
    <>
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <h1 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(38px, 5.5vw, 68px)', color: '#ffffff', lineHeight: '1.1', fontWeight: '700', marginBottom: '24px', letterSpacing: '-0.5px' }}>
                Job-Ready IT &{' '}
                <span style={{ color: '#5AB240' }}>Healthcare</span>
                <br />Courses in
                <br />
                <span style={{ color: '#5AB240', fontStyle: 'italic' }}>Ameerpet, Hyderabad</span>
              </h1>
      ...
      <style>{`
        ...
        @keyframes ringFloat { 0%, 100% { transform: scale(1); opacity: 0.06; } 50% { transform: scale(1.08); opacity: 0.12; } }
        @keyframes ringFloat2 { 0%, 100% { transform: scale(1); opacity: 0.04; } 50% { transform: scale(1.05); opacity: 0.09; } }
        .ring { position: absolute; border-radius: 50%; border: 1px solid #5AB240; pointer-events: none; z-index: 0; }
        .ring1 { width: 400px; height: 400px; top: -100px; right: 10%; animation: ringFloat 6s ease-in-out infinite; }
        .ring2 { width: 280px; height: 280px; top: 40px; right: calc(10% + 60px); animation: ringFloat2 8s ease-in-out infinite; animation-delay: 1s; }
        .ring3 { width: 180px; height: 180px; bottom: 60px; left: 5%; animation: ringFloat 10s ease-in-out infinite; animation-delay: 2s; }
