          ...
          <div className="course-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 360px', gap: '48px', alignItems: 'start' }}>
            ...
            <div>
              ...
              <div className="cta-row" style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                <a href="#enroll" style={{ background: '#5AB240', color: '#fff', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: '700', fontSize: '15px', flex: 1, textAlign: 'center', minWidth: '140px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
